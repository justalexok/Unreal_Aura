...
float UAuraGameplayAbility::GetManaCost(const float InLevel) const
{
	...
	if (const UGameplayEffect* CostEffect = GetCostGameplayEffect())
	{
		for (FGameplayModifierInfo Mod : CostEffect->Modifiers)
		{
			...
			{
				//if this ability has a cost effect, loop through the modifiers and if mod.attribute is the mana attribute...
				//then get the magnitude if its a static magnitude and set ManaCost
